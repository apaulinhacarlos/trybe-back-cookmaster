...
Neste projeto eu desenvolvi um app utilizando a arquitetura MSC!
...
```bash
git clone git@github.com:apaulinhacarlos/trybe-back-cookmaster.git
```

Acesse o diretório do projeto com o comando `cd`:

```bash
cd trybe-back-cookmaster
```
